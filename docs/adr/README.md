...
| [0011](./0011-browser-extension-architecture.md) | Browser extension — transport (direct WS) + style serialization (hybrid inline / inherited-diff) | Accepted (2026-04-24); extended by [ADR-0012](./0012-capture-fidelity-evolution.md) | `3ad3214` (whole-page capture), `36d2df2` (CSS-leak fix + body→div swap), `e1a38fd` (artboard per whole-page), `341ee77` (fit_artboard chain), `959331d` (class-hoist fix — load-bearing), `bb916ae` (v0.4 prep stubs `data-dj-uid` + serialize `mode`), `b1e0d0b` (font-CDN allowlist hoist). See [Addendum](./0011-browser-extension-architecture.md#addendum-2026-04-24--implementation-status); full followups in [`epic-8-followups.md`](../epic-8-followups.md). |
| [0012](./0012-capture-fidelity-evolution.md) | Capture fidelity evolution — hybrid screenshot backplate + CDP pivot + three-tool split + author/computed hybrid | §1 Accepted (2026-04-24); §§2–4 Proposed | §1 — `f6ae37f` (hybrid backplate stitcher + relay + class-hoisted styling). See [Addendum](./0012-capture-fidelity-evolution.md#addendum-2026-04-24--1-implementation-status). §§2–4 remain Proposed pending SingleFile licence price-check + CDP pivot design. |
